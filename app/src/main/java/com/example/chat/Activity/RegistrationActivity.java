        ...
        btn_SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(name) || TextUtils.isEmpty(email) ||
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(RegistrationActivity.this, "password does't match", Toast.LENGTH_SHORT).show();
                } else if(password.length() < 6 ){
                    progressDialog.dismiss();
                    Toast.makeText(RegistrationActivity.this, "password is too small", Toast.LENGTH_SHORT).show();
                } else{
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                ...
                                if(imageUri!=null){
                                    ...
                                    String status = "Hey There I'm Using ChatApp";
                                    imageURI = "https://firebasestorage.googleapis.com/v0/b/chat-17a5b.appspot.com/o/profile_image.png?alt=media&token=94b2c518-1078-4610-a22a-92c7a37a4b03";
                                    Users users = new Users(auth.getUid(),name,email,imageURI,status);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
